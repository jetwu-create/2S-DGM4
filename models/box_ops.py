...
def box_cxcywh_convert(x, W, H):
    x = x.cpu()
    x_c, y_c, w, h = x.unbind(-1)
    x_1 = (x_c*256 - 0.5*w*256)/(256/W)
    y_1 = (y_c*256 - 0.5*h*256)/(256/H)
    x_2 = (x_c*256 - 0.5*w*256)/(256/W) + w*256/(256/W)
    y_2 = (y_c*256 - 0.5*h*256)/(256/H) + h*256/(256/H)
    b = [x_1, y_1, x_2, y_2]
